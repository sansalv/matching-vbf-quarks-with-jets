...
#GoodFatJets msoftdrop
        ...
        df22_cut_ak8ms = df22.Filter("GoodFatJet_ms[1] > 50 && GoodFatJet_ms[1] < 200", "Events with >=2 good AK8 jets with 200 > ms > 50 GeV")
        df22_cut_leadingak8ms = df22_cut_ak8ms.Filter("GoodFatJet_ms[0] > 50 && GoodFatJet_ms[0] < 200", "Events with >0 good AK8 jets with 200 > ms > 50 GeV")
...
#XbbVsQCD 
        ...
        dfx_cut = dfx2.Filter('GoodFatJet_ParticleNetMD_XbbVsQCD[1] > 0.1', 'Events with >= 2 good AK8 Jets with XbbVsQCD > 0.1')
        dfx_cut_leading = dfx_cut.Filter('GoodFatJet_ParticleNetMD_XbbVsQCD[0] > 0.1', 'Events with > 0 good AK8 Jets with XbbVsQCD > 0.1')
