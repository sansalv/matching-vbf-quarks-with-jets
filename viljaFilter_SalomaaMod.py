...
#GJ Id (only in SalomaaMod version)
        dfdp1 = dfdp1.Define('GoodJet_jetId','Jet_jetId[%s]'%gj_cuts)\
                     .Define('GoodJet_puId','Jet_puId[%s]'%gj_cuts)
...
#HiggsEta
        ...
        dfc0 = dfr0.Define('GoodJet_FatJetCleaned_pt','GoodJet_pt[GoodJet_closestHiggsCandidateDeltaR > 1.2]')\
                ...
                .Define('GoodJet_FatJetCleaned_jetId','GoodJet_jetId[GoodJet_closestHiggsCandidateDeltaR > 1.2]')\
                .Define('GoodJet_FatJetCleaned_puId','GoodJet_puId[GoodJet_closestHiggsCandidateDeltaR > 1.2]')
...
#Muons&ElectronsForCleaning
        ...
        dfmc = dfmc0.Define('GoodJet_FatJetCleaned_closestMuonDeltaR','FindClosestDeltaR(GoodJet_FatJetCleaned_phi,GoodJet_FatJetCleaned_eta,MuonsForCleaning_phi,MuonsForCleaning_eta)')\
                ...
                .Define('GoodJet_FatJetAndMuonCleaned_jetId','GoodJet_FatJetCleaned_jetId[GoodJet_FatJetCleaned_closestMuonDeltaR > 0.4]')\
                .Define('GoodJet_FatJetAndMuonCleaned_puId','GoodJet_FatJetCleaned_puId[GoodJet_FatJetCleaned_closestMuonDeltaR > 0.4]')\
        ...
        dflc = dfec.Define('GoodJet_FatJetAndLeptonCleaned_pt','GoodJet_FatJetAndMuonCleaned_pt[GoodJet_closestElectronDeltaR > 0.4]')\
                ...
                .Define('GoodJet_FatJetAndLeptonCleaned_jetId','GoodJet_FatJetAndMuonCleaned_jetId[GoodJet_closestElectronDeltaR > 0.4]')\
                .Define('GoodJet_FatJetAndLeptonCleaned_puId','GoodJet_FatJetAndMuonCleaned_puId[GoodJet_closestElectronDeltaR > 0.4]')\
        ...
        dfvbf = dflc.Define('VBFCandidates_pt','ROOT::VecOps::Take(GoodJet_FatJetAndLeptonCleaned_pt,{0,1})')\
                ...
                .Define('VBFCandidates_jetId','ROOT::VecOps::Take(GoodJet_FatJetAndLeptonCleaned_jetId,{0,1})')\
                .Define('VBFCandidates_puId','ROOT::VecOps::Take(GoodJet_FatJetAndLeptonCleaned_puId,{0,1})')\
